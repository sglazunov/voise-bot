...
EXPECTED = {
    ...
    "GET /api/search",
    "GET /api/series",
    "GET /api/jobs/{job_id}/weeek-tasks",
    "POST /api/jobs/{job_id}/weeek-tasks/prepare",
    "POST /api/jobs/{job_id}/weeek-tasks/create",
    "POST /api/jobs/{job_id}/weeek-tasks/{key}/skip",
    "GET /api/automation/weeek/members",
    "GET /api/automation/weeek/boards",
    "GET /api/automation/weeek/board-columns",
    "POST /api/automation/weeek/user-map",
    "POST /api/series",
    "DELETE /api/series/{key}",
    "POST /api/series/{key}/forget-last",
    "GET /api/setup/auto",
    "GET /api/setup/deps",
    "GET /api/stats",
    "GET /api/stats/owner",
