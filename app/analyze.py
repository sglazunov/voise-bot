...
_RULES = (
    ...
    "- summary: 5-8 предложений — о чём была встреча в целом и какие темы затрагивали.\n"
    "- detailed: МАКСИМАЛЬНО ПОДРОБНЫЙ разбор по темам — раздели разговор на столько тем, "
    "сколько их реально было (обычно 6-15). У каждой темы два поля:\n"
    ...
    "    • details — ПОЛНОЕ, САМОДОСТАТОЧНОЕ описание темы на 10-12 предложений. Начни с "
    "того, о чём и в каком контексте шла речь (чтобы тема была понятна человеку, который "
    "не слушал запись), затем — что именно обсуждали, какие звучали предложения и "
    "возражения и почему, кто что сказал (по именам), конкретика (цифры, проценты, "
    "названия модулей/тегов/систем, сроки, примеры), и чем тема закончилась (к чему "
    "пришли / что решили / что осталось открытым). Пиши так, чтобы, прочитав ТОЛЬКО этот "
    "абзац, человек полностью понял тему. НЕ обобщай и НЕ сокращай — это главная часть "
    "протокола.\n"
