...
const tools = [
  ...
  // Страница подключения движков и ключей. 01.09 её убрали из меню «на время
  // перестройки» и забыли вернуть: маршрут /providers работал, но добраться до
  // него можно было только по прямой ссылке — и когда Gemini пропал из списка
  // движков, проверить ключ было негде.
...
const tabs = [
  ...
  // Внизу на телефоне — четыре самых частых экрана; «Нейросети» доступны
  // через «Ещё»: ключи вводят раз в месяц, планировщик открывают каждый день.
